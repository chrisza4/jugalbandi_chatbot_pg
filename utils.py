...
async def load_specific_scheme_prompt(
    interested_scheme_name, scheme_chatbot_prompt, engine
) -> (str, str):
    """
    ...
    interested_scheme_details = await db_obj.get_specific_scheme_details(
        scheme_name=interested_scheme_name
    )
